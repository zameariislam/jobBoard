    ...
    <div className="h-screen pt-14">
      ...
      <div className="flex justify-evenly ">
        <div
          ...
          className="  cursor-pointer flex  flex-col justify-between transition-all rounded-lg p-5 border border-white hover:border-primary hover:shadow-2xl hover:scale-105 group"
        >
